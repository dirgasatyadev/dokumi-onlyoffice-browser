...
4. Generate `pnpm package:source`.
5. Record runtime artifact and source archive SHA-256 values in the release manifest.
6. Publish both artifacts in the same GitHub release.
